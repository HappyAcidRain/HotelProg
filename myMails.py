...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 530px" id="">
    <tbody><tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody><tr>
                                    ...
                                    <td bgcolor="#3F3D33" width="50%" align="left" class="mobile-hide">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                <td align="left" style="padding: 0 0 5px 0; font-size: 12px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none"><span style="color: #ffffff; text-decoration: none">top text</span></td>
                                            </tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="ko_headerBlock_1">
    <tbody><tr>
                            ...
                            <tbody><tr>
                                <td valign="top" style="padding: 0" class="mobile-wrapper">
                                    <table border="0" cellpadding="0" cellspacing="0" width="30%" class="responsive-table" align="left">
                                        <tbody><tr>
                                            <td bgcolor="#ffffff">
                                            <a target="_new" href=""><img alt="" image-droppable="" width="150" class="img-max" border="0" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #3F3D33; font-size: 16px" src="https://mosaico.io/srv/f-l24l00p/img?method=placeholder&amp;params=150%2C80"></a></td>
                                        </tr>
                                    </tbody></table>
                                        ...
                                        <tbody><tr>
                                            <td bgcolor="#ffffff" align="center">
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tbody><tr>
                                                        <td align="center" style="padding: 10px 0 0 0px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #3F3D33; text-decoration: none"><span style="color: #3F3D33; text-decoration: none">Responsive Email Template.</span></td>
                                                    </tr>
...
</tbody></table><table border="0" cellpadding="0" cellspacing="0" width="100%" id="ko_onecolumnBlock_1">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody><tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody><tr>
                                            <td align="center" class="padding-copy" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #3F3D33; padding-top: 0px">Тест рассылки</td>
                                        </tr>
                                        <tr>
                                            <td align="center" class="padding-copy textlightStyle" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #3F3D33"><p style="margin: 0px;">это сообщение отправленно кодом!</p></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
...
<!-- FOOTER -->
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 500px" id="">
    <tbody><tr>
        <td bgcolor="#ffffff" align="center">
